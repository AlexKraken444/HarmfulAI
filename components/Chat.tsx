...
const suggestions = [
  ...
  "Как победить лень?",
  "Сгенерируй изображение моей идеальной работы",
  "Сгенерируй изображение моего понедельника",
];
            ...
            >
              ...
              <p className="text-purple-200/70 max-w-xl mx-auto mb-8">
                ...
                <span className="text-purple-200/50 text-sm">
                  Хочешь иллюстрацию? Начни сообщение со слов «Сгенерируй изображение...».
                </span>
              </p>
